const ballon = document.getElementById('air-balloon');
...
function move() {
    ...
    // the '10' refers to the height from the bottom of the sky section. We added this in the css file. Feel free to move all styling to the JS file if you prefer to keep the '10' consistent.
    ballon.style.bottom = 10 + incrementer * 0.1 + '%';

    cloudOne.style.bottom = 40 + incrementer * 0.12 + '%';
    cloudOne.style.left = 75 + incrementer * 0.2 + '%';
